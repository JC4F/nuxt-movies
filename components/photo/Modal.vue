...
<template>
  <div v-if="images && current" fixed top-0 left-0 right-0 bottom-0 z-10 bg-black:90 p5 flex items-center justify-center>
    <button type="button" absolute top-1 right-1 z-100 p-[0.75] text-3xl opacity-50 transition-all hover:opacity-100 bg-black:60 rounded-full @click="images = null">
      <div i-carbon-close />
    </button>
    <NuxtImg
